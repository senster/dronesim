...
def run_ai_simulation(output_dir, seed=None, num_drones=4, steps=200):
    ...
    return run_simulation(steps, ocean, drones, system, output_dir, pattern_name, pattern_params)
...
def run_simulation(steps, ocean, drones, system, output_dir, pattern_name, pattern_params={}):
    ...
    # Run the simulation
    print(f"Starting simulation with {pattern_name} pattern drones for {steps} steps...")
...
def main():
    ...
    parser.add_argument("--num-drones", "-n", type=int, default=4,
                        help="Number of drones to use (default: 4, only applicable for AI pattern)")
